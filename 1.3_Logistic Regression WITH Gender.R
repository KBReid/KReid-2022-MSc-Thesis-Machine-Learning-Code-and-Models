# Logistic regression models *WITH* Gender as a predictor variable
...
AOSI.training <- read_csv("R/03_Data/02_AOSI Machine Learning Datasets (Train-Test 80-20)/dx36 transformed to 0 and 1 for logistic regression/AOSI.training set Sept 15 2022_transformed.csv")
AOSI.testing <- read_csv("R/03_Data/02_AOSI Machine Learning Datasets (Train-Test 80-20)/dx36 transformed to 0 and 1 for logistic regression/AOSI.testing set Sept 15 2022_transformed.csv")
AOSI.independent <- read_csv("R/03_Data/03_AOSI new ASIB independent dataset/dx36 transformed to 0 and 1/AOSI.independent - dx36 transformed.csv")
...
# this code generates a custom summary function that allows for a more detailed model
#performance metric report. This code was sourced from a comment on stackoverflow;
# see link: https://stackoverflow.com/questions/52691761/additional-metrics-in-caret-ppv-sensitivity-specificity 
...
# function we can call when training the predictive models 
Custom.Ctrl <- trainControl(method = "cv",                         # the re-sampling method being used 
                            number = 10,                           # the number/fold of re-sampling iterations,
                            savePredictions = TRUE,                # saves the predicted 
                            summaryFunction = Custom.MySummary,    # calls the custom summary function defined above
                            classProbs = TRUE)              

# SECTION §4.0 -- logistic regression modelling ---- 

# REGARDING WARNING MESSAGES
# NOTE 1: The code below may output a warning message that can be discounted; the 
# warning almost always pops up because some tuning parameter combination produced 
# predictions that are constant for all samples. Caret's train() function tries to 
# compute the R^2 and, since it needs a non-zero variance, it can produce NA for 
# that statistic. See https://github.com/topepo/caret/issues/1124 for more detail. 

# error message in question is described below 
# In nominalTrainWorkflow(x = x, y = y, wts = weights, info = trainInfo,  :
#                          There were missing values in resampled performance measures.


# NOTE 2: Training some of the logistic regression models can result in a warning
# message posted below. This can stem from (1) two predictor variables being perfectly 
# correlated, or (2) there aare more model parameters than observations in the dataset.
# Given that there is *definitely* not more model parameters than observations 
...
# entirely plausible given AOSI scoring data. See the link for more detail
...
set.seed(17724)
cv_model_01 <- train(
  dx36 ~ Gender + AQ1 + AQ2 + AQ3 + AQ4 + AQ5 + AQ6 + AQ7 + AQ8 + AQ9 + AQ10 + AQ11 + AQ14 + AQ15 + AQ16 + AQ17 + AQ18, 
  data = AOSI.training, 
  method = "glm",
  metric = "ROC",
  family = "binomial",
...
# Generating vectors to store model statistics (when the model is applied to *TRAINING*
# data) to generate a data table for ease of recording/interpreting results
...
# test data) to generate a data table for ease of recording/interpreting results
...
{ probs01.proc.test <- predict(cv_model_01, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 01")
...
{ probs01.proc.train <- predict(cv_model_01, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 01")
...
{ probsIndependent01.proc <- predict(cv_model_01, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 01")
...
{ probs02.proc.test <- predict(cv_model_02, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 02")
...
{ probs02.proc.train <- predict(cv_model_02, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 02")
...
{ probsIndependent02.proc <- predict(cv_model_02, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 02")
...
{ probs03.proc.test <- predict(cv_model_03, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 03")
...
{ probs03.proc.train <- predict(cv_model_03, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 03")
...
{ probsIndependent03.proc <- predict(cv_model_03, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 03")
...
{ probs04.proc.test <- predict(cv_model_04, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 04")
...
{ probs04.proc.train <- predict(cv_model_04, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 04")
...
{ probsIndependent04.proc <- predict(cv_model_04, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 04")
...
{ probs05.proc.test <- predict(cv_model_05, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 05")
...
{ probs05.proc.train <- predict(cv_model_05, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 05")
...
{ probsIndependent05.proc <- predict(cv_model_05, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 05")
...
{ probs06.proc.test <- predict(cv_model_06, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 06")
...
{ probs06.proc.train <- predict(cv_model_06, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 06")
...
{ probsIndependent06.proc <- predict(cv_model_06, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 06")
...
{ probs07.proc.test <- predict(cv_model_07, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 07")
...
{ probs07.proc.train <- predict(cv_model_07, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 07")
...
{ probsIndependent07.proc <- predict(cv_model_07, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 07")
...
{ probs08.proc.test <- predict(cv_model_08, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 08")
...
{ probs08.proc.train <- predict(cv_model_08, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 08")
...
{ probsIndependent08.proc <- predict(cv_model_08, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 08")
...
{ probs09.proc.test <- predict(cv_model_09, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 09")
...
{ probs09.proc.train <- predict(cv_model_09, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 09")
...
{ probsIndependent09.proc <- predict(cv_model_09, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 09")
...
{ probs10.proc.test <- predict(cv_model_10, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 10")
...
{ probs10.proc.train <- predict(cv_model_10, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 10")
...
{ probsIndependent10.proc <- predict(cv_model_10, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 10")
...
{ probs11.proc.test <- predict(cv_model_11, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 11")
...
{ probs11.proc.train <- predict(cv_model_11, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 11")
...
{ probsIndependent11.proc <- predict(cv_model_11, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 11")
...
{ probs12.proc.test <- predict(cv_model_12, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 12")
...
{ probs12.proc.train <- predict(cv_model_12, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 12")
...
{ probsIndependent12.proc <- predict(cv_model_12, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 12")
...
{ probs13.proc.test <- predict(cv_model_13, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 13")
...
{ probs13.proc.train <- predict(cv_model_13, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 13")
...
{ probsIndependent13.proc <- predict(cv_model_13, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 13")
...
{ probs14.proc.test <- predict(cv_model_14, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 14")
...
{ probs14.proc.train <- predict(cv_model_14, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 14")
...
{ probsIndependent14.proc <- predict(cv_model_14, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 14")
...
{ probs15.proc.test <- predict(cv_model_15, newdata=AOSI.testing, type="prob")
  ...
  number.vector.test <- append(number.vector.test, "Test Model 15")
...
{ probs15.proc.train <- predict(cv_model_15, newdata=AOSI.training, type="prob")
  ...
  number.vector.train <- append(number.vector.train, "Train Model 15")
...
{ probsIndependent15.proc <- predict(cv_model_15, newdata=AOSI.independent, type="prob")
  ...
  number.vector.independent <- append(number.vector.independent, "Independent Model 15")
...
# SECTION §6.0 -- Generating a data frame with all results together ----
...
extracted.test.data
#write.table(extracted.test.data, file="Combined Results WITH gender on TEST data.csv", sep=",")
...
#write.table(extracted.train.data, file="Combined Results WITH gender on TRAIN data.csv", sep=",")
...
#write.table(extracted.independent.data, file="Combined Results WITH gender on INDEPENDENT data.csv", sep=",")