# Support Vector Machines using linear kernels *WITH* Gender as a predictor variables
...
# SECTION §2.0 -- code used to import the AOSI Training & Test Set data into R ----
...
# this code takes the customized summary function and puts it into a custom trControl
# function we can call when training the different predictive models 
Custom.Ctrl <- trainControl(method = "cv",
                            number = 10, 
                            savePredictions = TRUE,
                            summaryFunction = Custom.MySummary,
                            classProbs = TRUE)     

# SECTION §4.0 -- generating SVM with linear kernels ----

# MODEL 1: Item-level data
set.seed(17274) # for reproducibility 
cv_model_01 <- train(
  dx36 ~ Gender + AQ1 + AQ2 + AQ3 + AQ4 + AQ5 + AQ6 + AQ7 + AQ8 + AQ9 + AQ10 + AQ11 + AQ14 + AQ15 + AQ16 + AQ17 + AQ18,  # outcome (dx36) and the predictor variables AQ1, AQ2, etc.
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
...
set.seed(17274) # for reproducibility 
cv_model_02 <- train(
  dx36 ~ Gender + AQ1 + AQ2 + AQ3 + AQ4 + AQ5 + AQ6 + AQ7 + AQ8 + AQ9 + AQ10 + AQ11 + AQ14 + AQ15 + AQ16 + AQ17 + AQ18 + AQTS, 
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_03 <- train(
  dx36 ~ Gender + AQ1 + AQ2 + AQ3 + AQ4 + AQ5 + AQ6 + AQ7 + AQ8 + AQ9 + AQ10 + AQ11 + AQ14 + AQ15 + AQ16 + AQ17 + AQ18 + MSEL_ELCss + MSEL_ELCss + MSEL_VRss + MSEL_FMss + MSEL_RLss + MSEL_Elss, 
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_04 <- train(
  dx36 ~ Gender + AQ1 + AQ2 + AQ3 + AQ4 + AQ5 + AQ6 + AQ7 + AQ8 + AQ9 + AQ10 + AQ11 + AQ14 + AQ15 + AQ16 + AQ17 + AQ18 + AQTS + MSEL_ELCss + MSEL_ELCss + MSEL_VRss + MSEL_FMss + MSEL_RLss + MSEL_Elss, 
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_05 <- train(
  dx36 ~ Gender + AQTS + MSEL_ELCss + MSEL_ELCss + MSEL_VRss + MSEL_FMss + MSEL_RLss + MSEL_Elss, 
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_06 <- train(
  dx36 ~ Gender + MSEL_ELCss + MSEL_ELCss + MSEL_VRss + MSEL_FMss + MSEL_RLss + MSEL_Elss, 
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_08 <- train(
  dx36 ~ Gender + AQ6 + AQ8 + AQ14 + AQ16 + AQ18, 
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_09 <- train(
  dx36 ~ Gender + AQ6 + AQ8 + AQ14 + AQ16 + AQ18 + AQTS, 
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_10 <- train(
  dx36 ~ Gender + AQ6 + AQ8 + AQ14 + AQ16 + AQ18 + MSEL_ELCss + MSEL_VRss + MSEL_FMss + MSEL_RLss + MSEL_Elss, 
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_11 <- train(
  dx36 ~ Gender + AQ6 + AQ8 + AQ14 + AQ16 + AQ18 + AQTS + MSEL_ELCss + MSEL_VRss + MSEL_FMss + MSEL_RLss + MSEL_Elss, 
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_13 <- train(
  dx36 ~ Gender + AQ8 + AQ14 + AQ18 + AQTS, 
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_14 <- train(
  dx36 ~ Gender + AQ8 + AQ14 + AQ18 + MSEL_ELCss + MSEL_VRss + MSEL_FMss + MSEL_RLss + MSEL_Elss,
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
set.seed(17274) # for reproducibility 
cv_model_15 <- train(
  dx36 ~ Gender + AQ8 + AQ14 + AQ18 + AQTS + MSEL_ELCss + MSEL_VRss + MSEL_FMss + MSEL_RLss + MSEL_Elss,
  data = AOSI.training, 
  method = "svmLinear",
  metric = "ROC",
  trControl = Custom.Ctrl,
...
# Generating vectors to store model statistics (when the model is applied to *TEST*
# data) to generate a data table for ease of recording/interpreting results
...
# Generating vectors to store model statistics (when the model is applied to 
# *TRAINING* data) to generate a data table for ease of recording/interpreting results
...
# Generating vectors to store model statistics (when the model is applied to *INDEPENDENT* 
# validation set data) to generate a data table for ease of recording/interpreting results
...
# Model 01 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 01 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 01 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 01 - SVM linear - WITH gender")
...
# Model 02 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 02 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 02 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 02 - SVM linear - WITH gender")
...
# Model 03 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 03 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 03 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 03 - SVM linear - WITH gender")
...
# Model 04 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 04 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 04 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 04 - SVM linear - WITH gender")
...
# Model 05 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 05 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 05 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 05 - SVM linear - WITH gender")
...
# Model 06 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 06 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 06 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 06 - SVM linear - WITH gender")
...
# Model 07 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 07 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 07 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 07 - SVM linear - WITH gender")
...
# Model 08 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 08 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 08 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 08 - SVM linear - WITH gender")
...
# Model 09 performance calculations on testing and training data
# calculate and extract model performance on the*TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 09 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 09 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 09 - SVM linear - WITH gender")
...
# Model 10 performance calculations on testing and training data
# calculate and extract model performance on the*TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 10 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 10 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 10 - SVM linear - WITH gender")
...
# Model 11 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 11 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 11 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 11 - SVM linear - WITH gender")
...
# Model 12 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 12 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 12 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 12 - SVM linear - WITH gender")
...
# Model 13 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 13 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 13 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 13 - SVM linear - WITH gender")
...
# Model 14 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 14 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 14 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 14 - SVM linear - WITH gender")
...
# Model 15 performance calculations on testing and training data
# calculate and extract model performance on the *TESTING* set.
{
  # Compute AUC for predicting Class with the model
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 15 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 15 - SVM linear - WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 15 - SVM linear - WITH gender")
...
write.table(extracted.train.data, file="Combined svmLinear Results WITH gender on TRAIN data.csv", sep=",")
...
extracted.test.data
write.table(extracted.test.data, file="Combined svmLinear Results WITH gender on TEST data.csv", sep=",")
...
write.table(extracted.independent.data, file="Combined svmLinear Results WITH gender on INDEPENDENT data.csv", sep=",")

save(cv_model_01, file = "svmLinear TL10 WITH gender cv_model_01.rda")
save(cv_model_02, file = "svmLinear TL10 WITH gender cv_model_02.rda")
save(cv_model_03, file = "svmLinear TL10 WITH gender cv_model_03.rda")
save(cv_model_04, file = "svmLinear TL10 WITH gender cv_model_04.rda")
save(cv_model_05, file = "svmLinear TL10 WITH gender cv_model_05.rda")
save(cv_model_06, file = "svmLinear TL10 WITH gender cv_model_06.rda")
save(cv_model_07, file = "svmLinear TL10 WITH gender cv_model_07.rda")
save(cv_model_08, file = "svmLinear TL10 WITH gender cv_model_08.rda")
save(cv_model_09, file = "svmLinear TL10 WITH gender cv_model_09.rda")
save(cv_model_10, file = "svmLinear TL10 WITH gender cv_model_10.rda")
save(cv_model_11, file = "svmLinear TL10 WITH gender cv_model_11.rda")
save(cv_model_12, file = "svmLinear TL10 WITH gender cv_model_12.rda")
save(cv_model_13, file = "svmLinear TL10 WITH gender cv_model_13.rda")
save(cv_model_14, file = "svmLinear TL10 WITH gender cv_model_14.rda")
save(cv_model_15, file = "svmLinear TL10 WITH gender cv_model_15.rda")
