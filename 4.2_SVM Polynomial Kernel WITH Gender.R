# Support Vector Machines using polynomial kernels *WITH* Gender as a predictor variables
...
# SECTION §4.0 -- generating SVM with polynomial kernels ----

# NOTE: tuneLength is set to 6 and not 10 due to the length of time it takes to 
# generate models. This process is incredibly computationally demanding. By setting 
# tuneLength to 10, it would require approximately ~1 day of run time *per* 
# polynomial SVM model (out of 15 total) using the code specified below. Using 
# tuneLength = 6 is much faster and was chosen as it does not require a month to 
# generate all of the polynomial SVM models being calculated in the study. That said, 
# it will still take you upwards of several hours per SVM model depending on the
...
save(cv_model_01, file = "svmPoly WITH gender TL06 cv_model_01.rda")
...
save(cv_model_02, file = "svmPoly WITH gender TL06 cv_model_02.rda")
...
save(cv_model_03, file = "svmPoly WITH gender TL06 cv_model_03.rda")
...
save(cv_model_04, file = "svmPoly WITH gender TL06 cv_model_04.rda")
...
save(cv_model_05, file = "svmPoly WITH gender TL06 cv_model_05.rda")
...
save(cv_model_06, file = "svmPoly WITH gender TL06 cv_model_06.rda")
...
save(cv_model_07, file = "svmPoly WITH gender TL06 cv_model_07.rda")
...
save(cv_model_08, file = "svmPoly WITH gender TL06 cv_model_08.rda")
...
save(cv_model_09, file = "svmPoly WITH gender TL06 cv_model_09.rda")
...
save(cv_model_10, file = "svmPoly WITH gender TL06 cv_model_10.rda")
...
save(cv_model_11, file = "svmPoly WITH gender TL06 cv_model_11.rda")
...
save(cv_model_12, file = "svmPoly **WITH** Gender TL06 cv_model_12.rda")
...
save(cv_model_13, file = "svmPoly WITH gender TL06 cv_model_13.rda")
...
save(cv_model_14, file = "svmPoly WITH gender TL06 cv_model_14.rda")
...
save(cv_model_15, file = "svmPoly WITH gender TL06 cv_model_15.rda")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 01 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 01 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 01 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 02 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 02 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 02 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 03 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 03 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 03 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 04 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 04 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 04 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 05 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 05 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 05 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 06 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 06 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 06 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 07 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 07 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 07 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 08 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 08 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 08 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 09 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 09 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 09 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 10 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 10 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 10 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 11 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 11 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 11 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 12 - SVM Poly ***WITH*** Gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 12 - SVM Poly ***WITH*** Gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 12 - SVM Poly ***WITH*** Gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 13 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 13 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 13 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 14 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 14 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 14 - SVM Poly WITH gender")
...
# calculate and extract model performance on the *TESTING* set.
{
  ...
  number.vector.test <- append(number.vector.test, "Test - Model 15 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.train <- append(number.vector.train, "Train - Model 15 - SVM Poly WITH gender")
...
{ 
  ...
  number.vector.independent <- append(number.vector.independent, "Independent - Model 15 - SVM Poly WITH gender")
...
write.table(extracted.train.data, file="Combined svmPoly Results WITH gender on TRAIN data.csv", sep=",")
...
extracted.test.data
write.table(extracted.test.data, file="Combined svmPoly Results WITH gender on TEST data.csv", sep=",")
...
write.table(extracted.independent.data, file="Combined svmPoly Results WITH gender on INDEPENDENT data.csv", sep=",")