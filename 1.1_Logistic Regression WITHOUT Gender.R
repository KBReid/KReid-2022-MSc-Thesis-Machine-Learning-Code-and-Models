# Logistic regression models *WITHOUT* gender as a predictor variable
...
extracted.test.data
#write.table(extracted.test.data, file="Combined Results WITHOUT gender on TEST data.csv", sep=",")
...
#write.table(extracted.train.data, file="Combined Results WITHOUT gender on TRAIN data.csv", sep=",")
...
#write.table(extracted.independent.data, file="Combined Results WITHOUT gender on INDEPENDENT data.csv", sep=",")