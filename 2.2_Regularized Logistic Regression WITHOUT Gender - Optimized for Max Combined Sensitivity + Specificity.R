# Regularized Logistic Regression Models *WITHOUT* Gender optimized for maximum combined sensitivity and specificity 
...
# (which is a value between 0 and 1) for regularized logistic regression models 
# generated using AOSI data that yields the highest possible combined sensitivity
# and specificity. 

# This work was completed because after regularized logistic model generation, 
# the models will, by default, use a decision threshold of 0.500 which may or may 
# not be the optimal decision boundary when classifying for ASD (in the case of 
# models built using AOSI data trying to predict 36 month ASD diagnoses). 

# Required R pre-requisites  ---- 
library(pROC)     # for ROC curve analysis 

# RegLogistic models applied to and optimized for **TRAINING** data ----
...
threshold01 <- 0.359    # corresponds to the optimum probability decision threshold
...
# RegLogistic models applied to and optimized for **TESTING** data ----
...
# RegLogistic models applied to and optimized for **INDEPENDENT** data ----
